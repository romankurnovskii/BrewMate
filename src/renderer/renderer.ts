...
function setupEventListeners(): void {
  ...
  ipcRenderer.on('all-apps', (_event: any, apps: Array<App>) => {
    ...
    allApps = apps;
    // Precompute lowercase strings and categories for faster searching
  ...
  requestAnimationFrame(() => {
    ...
    filteredApps = allApps.filter((app) => {
      ...
      if (selectedCategory === 'Installed') {
        ...
        matchesCategory = app._category === selectedCategory;
      }
      ...
      return (
        (app._nameLower && app._nameLower.includes(searchLower)) ||
        (app._descLower && app._descLower.includes(searchLower)) ||
        (app._homeLower && app._homeLower.includes(searchLower))
      );
    });
