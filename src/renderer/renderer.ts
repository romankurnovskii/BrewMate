  ...
  requestAnimationFrame(() => {
    ...
    if (!searchLower && selectedType === 'All' && selectedCategory === 'All') {
      ...
      if (selectedCategory === 'Installed') {
        ...
        // Optimization: Native for loop avoids callback closure overhead and array allocations from .filter(), significantly improving performance on massive datasets
